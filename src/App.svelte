...
import 'bootstrap/dist/css/bootstrap.min.css';
  ...
  <main>
	<form on:submit|preventDefault={handleSubmit}>
	  ...
	  <div>
		<label for="name" class="form-label" style="padding-bottom:10px;">Name</label>
	  ...
	  <div>
		<label for="email" class="form-label" style="padding-bottom:10px;">Email</label>
	...
	<div>{#if errors.email}<p class="error" style="color:red;">{errors.email}</p>{/if}</div>
	  ...
	  <div>
		<label for="password" class="form-label" style="padding-bottom:10px;">Password</label>
	...
	<div>{#if errors.password}<p class="error" style="color:red;">{errors.password}</p>{/if}</div>
	  ...
	  <div>
		<label for="confirmPassword" class="form-label" style="padding-bottom:10px;">Confirm Password</label>
